...
int main(int argc, char** argv)
{
    ...
    Window window {800, 600, "Getting Started: Coordinate Systems Multiple"};
    ...
    while (window.isOpen())
    {
        ...
        for (std::size_t i {}; i < 10; ++i)
        {
            ...
            model = model * rotate(angle * DryPhys::Constants::pi / 180, DryPhys::Vector3D {1.0f, 0.3f, 0.5f});
