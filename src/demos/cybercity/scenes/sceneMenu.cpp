...
void SceneMenu::init()
{
    ...
    levelPaths_.push_back("application\\config\\CP-Level1.txt");
    levelPaths_.push_back("application\\config\\CP-Level2.txt");
    levelPaths_.push_back("application\\config\\CP-Level3.txt");
    ...
    if (!music_)
        music_ = std::move(game_->assets().getMusic("LastArea"));
